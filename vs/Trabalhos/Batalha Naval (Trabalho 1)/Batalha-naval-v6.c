...
int main()
{
    ...
    int i_1[s],j_1[s],i_4[s],j_4[s];                //Armazenam a posicao dos submarinos
	...
	while(sub<s){ //Determina a posicao dos submarinos pseudo-aleatoriamente
        ...
        if((oceano[i_1[sub]][j_1[sub]]==' ')){
            ...
            sub++;    
            if((i_1[sub-1]==i_4[sub])&&(j_1[sub-1]==j_4[sub])){
                i_4[sub]=i_1[sub];
                j_4[sub]=j_1[sub];
                rep=1;
            }
            else if((i_1[sub-1]==i_4[sub])&&(j_1[sub]==j_4[sub])){
                i_4[sub]=i_1[sub];
                j_4[sub]=j_1[sub];
                rep=1;
            }
            else if((i_1[sub-1]==i_4[sub])&&(j_1[sub+1]==j_4[sub])){
                i_4[sub]=i_1[sub];
                j_4[sub]=j_1[sub];
                rep=1;
            }
            else if((i_1[sub]==i_4[sub])&&(j_1[sub-1]==j_4[sub])){
                i_4[sub]=i_1[sub];
                j_4[sub]=j_1[sub];
                rep=1;
            }
